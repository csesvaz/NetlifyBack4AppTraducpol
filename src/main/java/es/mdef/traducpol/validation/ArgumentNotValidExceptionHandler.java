package es.mdef.traducpol.validation;
...
import es.mdef.traducpol.rest.RegisterNotFoundException;
...
public class ArgumentNotValidExceptionHandler {
    ...
    public Map<String, String> handleValidationExceptions2(ConstraintViolationException ex) {
        Map<String, String> errors = new HashMap<>();
